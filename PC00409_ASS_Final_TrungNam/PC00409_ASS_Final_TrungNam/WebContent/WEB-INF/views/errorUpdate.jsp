                        ...
                        <div class="error-content">
                            <div class="card mb-0">
                                <div class="card-body text-center pt-5">
                                    ...
                                    <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Lỗi nhập</h4>
                                    <p style="color: #ff0000;">Vui lòng nhập đầy đủ các trường dữ liệu trong form ${table}!</p>
                                    <form class="mt-5 mb-5">
                                        <div class="text-center mb-4 mt-4"><a href="${url}" class="btn btn-primary">Quay lại trang cũ</a>
                                        </div>
                                    </form>
                                    <div class="text-center">
                                        <p>Copyright © Designed by <a href="https://themeforest.net/user/digitalheaps">SASS_HTN</a>, Developed by <a href="https://themeforest.net/user/quixlab">SASS_HTN</a></p>
